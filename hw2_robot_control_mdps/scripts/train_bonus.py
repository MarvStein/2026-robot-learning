...
from utils import *
from env.so100_tracking_env_bonus import SO100TrackEnvBonus
...
def make_env():
    def _init():
        env = SO100TrackEnvBonus(xml_path=XML_PATH, render_mode=None)
...
if __name__ == "__main__":
    ...
    if args.num_envs > 1:
        ...
        env = SO100TrackEnvBonus(xml_path=XML_PATH, render_mode="human")
        model = PPO(
            "MlpPolicy",
            env,
            device=args.device,
